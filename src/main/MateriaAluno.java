...
public class MateriaAluno {
	...
	public void imprimeLista() {
		for (int i = 0; i < this.tamanhoLista(); i++) {
			System.out.println("Elemento " + i + " : {" + this.listaGetAt(i).imprimivel() + "}"); // get at retorno o
																									// elemento na
																									// posicao i ,
																									// imprimivel torna
																									// o objeto Materia
	...
	public void imprimePedido() {
		for (int i = 0; i < this.tamanhoPedido(); i++) {
			System.out.println("Elemento " + i + " : {" + this.pedidoGetAt(i).imprimivel() + "}"); // get at retorno o
																									// elemento na
																									// posicao i ,
																									// imprimivel torna
																									// o objeto Materia
	...
	public String[][] pedidoToMatriz() {
		...
		for (i = 0; i < this.tamanhoPedido(); ++i) {
			data[i] = this.pedidoGetAt(i).imprimivel().split(","); // get at retorno o elemento na posicao i ,
																	// imprimivel torna o objeto Materia imprimivel com
																	// o println
		}
